          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Add a YouTube video to showcase your property (walkthrough,
                  tour, or highlights)
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Paste any YouTube video link. It will be automatically
                    converted to an embedded player.
                  </p>
                </div>
                ...
                {formData.youtubeUrl && (
                  <div className="mt-4">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      This is how the video will appear on your property
                      listing.
                    </p>
                  </div>
                )}
